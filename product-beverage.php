...
<p class="price" style="margin-left:20px;"><?php echo htmlentities($result->SizeName);?>&nbsp<?php echo htmlentities($result->Ounce);?> oz.</td>&nbsp | <?php echo htmlentities($result->Price);?>EGP </p>
