...
header('location:loginmember.php');
  ...
  if (isset($_POST['addcart'])) {
    ...
    $sql = "INSERT INTO cart (ProductCode, ProductName, ProductImage, ProductPrice, Quantity, TotalPrice, Username, Status) 
            VALUES (:productcode, :productname, :productimage, :productprice, :quantity, :total, :username, :status)";
    ...
    $sql = "INSERT INTO history (ProductCode, ProductName, ProductImage, ProductPrice, Quantity, TotalPrice, Username, Status) 
            VALUES (:productcode, :productname, :productimage, :productprice, :quantity, :total, :username, :status)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':productcode', $productcode, PDO::PARAM_STR);
    $query->bindParam(':productname', $productname, PDO::PARAM_STR);
